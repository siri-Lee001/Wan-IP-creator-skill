...
def main():
    ...
    # 水彩简化风格提示词
    prompt = """转换为水彩画艺术风格，简化线条，水彩渲染效果，柔和色彩，生成单一角色正面主体图，去掉三视图的多视图布局，只保留单个完整的角色，100%保留角色核心视觉特征。"""
    
    print(f"提示词长度: {len(prompt)} 字符")
    print("正在调用万相API生成水彩简化风格图...（预计耗时30-60秒）")
    ...
    if result and len(result) > 0:
        ...
        output_path = os.path.join(output_dir, "giraffe_watercolor_style.jpg")

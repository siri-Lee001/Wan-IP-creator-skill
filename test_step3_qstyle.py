...
def main():
    ...
    # Q版风格提示词
    prompt = """转换为Q版可爱风格，二头身比例，卡通渲染效果，萌系表情，生成单一角色正面主体图，去掉三视图的多视图布局，只保留单个完整的角色，100%保留角色核心视觉特征。"""
    
    print(f"提示词长度: {len(prompt)} 字符")
    print("正在调用万相API生成Q版风格图...（预计耗时30-60秒）")
    ...
    if result and len(result) > 0:
        ...
        output_path = os.path.join(output_dir, "giraffe_qstyle.jpg")

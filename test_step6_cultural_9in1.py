...
要求：单张大图，九宫格布局，产品设计美观实用，生成单一角色正面主体图，去掉三视图的多视图布局，只保留单个完整的角色，100%保留角色核心视觉特征。"""
    
    print(f"提示词长度: {len(prompt)} 字符")
    print("正在调用万相API生成文创设计九合一图...（预计耗时30-60秒）")
    ...
    if result and len(result) > 0:
        ...
        output_path = os.path.join(output_dir, "giraffe_cultural_9in1.jpg")
